...
class Web extends CI_Controller
{
    ...
    public function customer_save()
    {
        ...
        $this->form_validation->set_rules('customer_country', 'Customer Country', 'required|callback_select_validate');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($result) {
                ...
                $message = str_replace('EMP_NAME', $data['customer_name'], NEW_REGISTERATION_MAIL);
                $message = str_replace('EMP_NAME', $data['customer_email'], $message);
                $Status = sendmail($data['customer_name'], "Congratulations! You're Now a Registered Member of <a href='https://ShopQuicky.in'>ShopQuicky.in</a>", $message);
    ...
    public function privacy(){
        $this->load->view('web/inc/header');
                $this->load->view('web/pages/privacy');
                $this->load->view('web/inc/footer');
    }
