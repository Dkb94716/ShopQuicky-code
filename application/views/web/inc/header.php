    ...
    <div class="wrap">
        <div class="header_top">
            ...
            <div class="header_top_right">
                <?php if(is_int(strpos($this->uri->uri_string(),"product"))){ ?>
                <div class="search_box">
                    <form method="get" action="<?php echo base_url('search')?>">
                        <input type="text" placeholder="Search for Products" id="srh" name="search" value="<?php if(isset($search)){echo $search;} ?>">
                ...
                if ($customer_id) {
                    ?>
                    <div class="login email_id"><p><?php echo $this->session->userdata('customer_email'); ?></p></div>
        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                ...
                <li class="<?php
                if ($this->uri->uri_string() == 'product' || substr($this->uri->uri_string(), 4, 7) == 'product') {
                    echo "active";
                }
...
<script>
        function empty() {
    var x;
    x = document.getElementById("srh").value.trim();
    if (x == "") {console.log("xxdgfhjklm");
        return false;
    };
}
</script>